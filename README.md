...
HTML that is readable and accessible

2. Name two big differences between ```display: block;``` and ```display: inline;```.

display:block creates a new line vertically while inline does not and stays horizontal
...
works on all the items in selected div 

5. Explain why git is valuable to a team of developers.

for version control, if they there is something broken they can roll back, and they can also have multiple people contributing without it geting too messy
